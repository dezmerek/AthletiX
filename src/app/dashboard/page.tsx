...
export default function DashboardPage() {
  ...
  const recentActivities: RecentActivity[] = [
    ...
    },
    {
      ...
      description: "2,200 / 2,200 kcal • Białko: 145g",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {quickStats.map((stat) => (
            <Link
              key={stat.id}
              href={stat.href}
              className="group bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-200"
            >
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
              ...
              <Link
                href="/dashboard/calendar"
                className="block mt-4 text-center text-sm text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors"
              >
