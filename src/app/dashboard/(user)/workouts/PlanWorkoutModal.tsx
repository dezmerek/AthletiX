...
export default function PlanWorkoutModal({
  isOpen,
  onClose,
  onPlan,
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl p-6 w-full max-w-4xl shadow-xl border border-slate-200 dark:border-slate-700">
        ...
        <div className="flex gap-3 mt-6">
          <button
            ...
            className="flex-1 px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-slate-300 text-white rounded-lg transition-colors duration-200"
          >
            {t("actions.planWorkout")}
          </button>
          <button
