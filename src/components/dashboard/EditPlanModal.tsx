...
export default function EditPlanModal({
  ...
  const [planStatus, setPlanStatus] = useState<"active" | "inactive" | "draft">(
    "draft"
  );
  ...
  useEffect(() => {
    if (plan) {
      ...
      setStartDate(plan.startDate.split("T")[0]); // Convert ISO string to date input format
      setEndDate(plan.endDate ? plan.endDate.split("T")[0] : "");

      // Goals
      setCurrentWeight(plan.goals.weight?.toString() || "");
      setTargetWeight(plan.goals.targetWeight?.toString() || "");
      setStrengthGoals(
      ...
      setFlexibilityGoals(
        plan.goals.flexibility && plan.goals.flexibility.length > 0
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Note about training and nutrition plans */}
