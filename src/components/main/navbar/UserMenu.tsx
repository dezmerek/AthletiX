  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      <button
        ...
        className="hidden items-center space-x-3 px-3 py-2 rounded-lg text-slate-600 dark:text-slate-300 hover:text-emerald-500 dark:hover:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-slate-700 transition-all duration-200 group md:flex"
      >
      ...
      >
        <div className="py-1.5">
          ...
          <div className="border-t border-slate-100 dark:border-slate-700/70 my-1"></div>
          ...
          <button
            ...
            className="w-full px-4 py-2.5 text-left text-sm font-medium text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-600 transition-colors cursor-pointer flex items-center space-x-3"
          >
            <svg
              className="w-5 h-5"
              fill="none"
